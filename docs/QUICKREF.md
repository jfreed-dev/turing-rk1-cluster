...
Store in environment variables (not in git):

```bash
# Add to ~/.bashrc or source from .env.local
...
tpi flash -n 1 --image-url "<talos-image-url>"
```
...
# Serial console (on BMC)
picocom /dev/ttyS2 -b 115200   # Node 1
picocom /dev/ttyS3 -b 115200   # Node 2
picocom /dev/ttyS4 -b 115200   # Node 3
picocom /dev/ttyS5 -b 115200   # Node 4
```
